<template>
  <div v-if="loading == true">
    <h2 style="color: black">Liste des adresses de la société :</h2>
    <p style="color: black">
      <span v-if="items && items[0]">
        {{ items[0].societe_name }}({{ items[0].societe_email }})
      </span>
    </p>
    <div class="card">
      <div class="m-2">
    ...
    index() {
      ...
      this.$http
        .post("/admin/adresses/index", {
          societe: this.$router.currentRoute.params.id,
        })
        .then((res) => {
          this.items = res.data;
